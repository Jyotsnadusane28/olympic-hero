...
s = summer_df.groupby(['Country_Name','Total_Summer']).size().unstack()
s.plot(kind  = 'bar',stacked = False)
plt.xlabel = ("Country_Name")
plt.ylabel = ("Total_Summer")
plt.show()
w = winter_df.groupby(['Country_Name','Total_Summer']).size().unstack()
w.plot(kind = 'bar',stacked=False)
plt.xlabel = ("Country_Name")
plt.ylabel = ("Total_Summer")
plt.show()
t = top_df.groupby(['Country_Name','Total_Summer']).size().unstack()
